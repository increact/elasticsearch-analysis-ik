...
public class AnalysisIkPlugin extends Plugin implements AnalysisPlugin {
    ...
    public Map<String, AnalysisModule.AnalysisProvider<TokenizerFactory>> getTokenizers() {
        ...
        extra.put("ecomm_ik_smart", IkTokenizerFactory::getIkSmartTokenizerFactory);
        extra.put("ecomm_ik_max_word", IkTokenizerFactory::getIkTokenizerFactory);
    ...
    public Map<String, AnalysisModule.AnalysisProvider<AnalyzerProvider<? extends Analyzer>>> getAnalyzers() {
        ...
        extra.put("ecomm_ik_smart", IkAnalyzerProvider::getIkSmartAnalyzerProvider);
        extra.put("ecomm_ik_max_word", IkAnalyzerProvider::getIkAnalyzerProvider);
